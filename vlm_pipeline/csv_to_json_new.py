...
PROMPT_TEMPLATE = (
    "You are a Clearpath Jackal Robot tasked with navigating along a global path while avoiding obstacles. "
    "Your current linear velocity is {linear_vel} m/s, and angular velocity is {angular_vel} rad/s.\n"
    "Task: Predict {number} {algorithm} planner parameters to help improve path-following and obstacle-avoidance.\n"
    "The output should be a JSON with the following fields: {output_format}\n"
    "Scene Overview: The blue line represents the robot's direction (x-axis), green is the y-axis, and the yellow object is the robot's current position."
)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--alg', default="teb")
