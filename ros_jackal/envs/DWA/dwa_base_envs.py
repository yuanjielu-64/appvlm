...
class DWABase(gym.Env):
    ...
    def launch_gazebo(self, world_name, gui, verbose):
        ...
        self.WORLD_PATH = join(self.BASE_PATH, "worlds/BARN1/")
    ...
    def step(self, action):
        ...
        info = self._get_info()
        self.jackal_ros.set_params(action_0)
        self.gazebo_sim.pause()
    ...
    def _set_start_goal_BARN(self, init_position, goal_position):
        ...
        self.jackal_ros = JackalRos(init_position = init_position, goal_position = goal_position, use_move_base = True, img_dir = self.img_dir, world_path = self.WORLD_PATH)
