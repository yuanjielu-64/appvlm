...
class JackalBase(gym.Env):
    ...
    def set_start_goal_BARN(self, init_position, goal_position):
        ...
        self.jackal_ros = JackalRos(init_position = init_position, goal_position = goal_position, img_dir = self.img_dir)
    ...
    def step(self, action):
        ...
        if self.jackal_ros.row == None:
            self.jackal_ros.set_params([1.5, 3])
        else:
            self.jackal_ros.set_params([self.jackal_ros.row["max_vel_x"], self.jackal_ros.row["max_vel_theta"]])
    ...
    def _get_success(self):
        robot_position = [self.jackal_ros.state.x, self.jackal_ros.state.y]
    ...
    def _get_flip_status(self):
        robot_position = self.jackal_ros.state.z
